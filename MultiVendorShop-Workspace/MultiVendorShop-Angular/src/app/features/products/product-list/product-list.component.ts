...
@Component({
  ...
  styles: [`
    ...
    .product-img { position: relative; height: 160px; background: var(--ivory-dark); border-radius: var(--radius-lg) var(--radius-lg) 0 0; display: flex; align-items: center; justify-content: center; overflow: hidden; }
